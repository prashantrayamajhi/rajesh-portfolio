...
const experiences = [
  {
    ...
    date: "2023 - Present",
    points: [
      "Analyzing sales performance data for companies, enhancing their revenue growth.",
      "Conducting market analysis, supporting product development and competitive positioning.",
      "Optimizing database management, resulting in a reduction in data retrieval time.",
      "Performing statistical analysis by identifying key risk factors and reducing claim processing time.",
    ],
  },
  {
    title: "Computer Operator",
    company_name: "Gokarneshwor Municipality",
    icon: "/company/avm.webp",
    iconBg: "#383E56",
    date: "2015 -  2023",
    points: [
      "Monitoring and maintaining computer systems to ensure optimal performance and security.",
      "Performing regular backups and data recovery operations.",
      "Troubleshooting hardware and software issues and providing technical support.",
